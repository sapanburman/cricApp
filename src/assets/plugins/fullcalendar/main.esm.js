...
var CalendarComponent = /** @class */ (function (_super) {
    ...
    CalendarComponent.prototype.renderToolbars = function (viewSpec, dateProfile, currentDate, dateProfileGenerator, title) {
        ...
        if (headerLayout) {
            if (!this.header) {
                this.header = new Toolbar(this.context, 'fc-client-header-toolbar');
        ...
        if (footerLayout) {
            if (!this.footer) {
                this.footer = new Toolbar(this.context, 'fc-client-footer-toolbar');
...
StandardTheme.prototype.classes = {
    widget: 'fc-unthemed',
    widgetHeader: 'fc-widget-client-header',
    widgetContent: 'fc-widget-content',
    buttonGroup: 'fc-button-group',
    button: 'fc-button fc-button-primary',
    buttonActive: 'fc-button-active',
    popoverHeader: 'fc-widget-client-header',
    popoverContent: 'fc-widget-content',
    // day grid
    headerRow: 'fc-widget-client-header',
...
// Computes a default column client-header formatting string if `colFormat` is not explicitly defined
...
function renderDateCell(dateMarker, dateProfile, datesRepDistinctDays, colCnt, colHeadFormat, context, colspan, otherAttrs) {
    ...
    // if only one row of days, the classNames on the client-header can represent the specific days beneath
    if (datesRepDistinctDays) {
        classNames = classNames.concat(
        // includes the day-of-week class
        // noThemeHighlight=true (don't highlight the client-header)
