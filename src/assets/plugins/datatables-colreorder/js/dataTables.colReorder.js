...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo, drop, invalidateRows )
{
	...
	/* Reposition the client-header elements in the client-header layout array */
...
$.extend( ColReorder.prototype, {
	...
	/**
	 * Mouse down on a TH element in the table client-header
	 *  @method  _fnMouseDown
	...
	"_fnRegions": function ()
	{
        ...
        for (var i = 0; i < aoColumnBounds.length; i++) {
            ...
            /* For the column / client-header in question, we want it's position to remain the same if the
	...
	"_fnCreateDragNode": function ()
	{
		...
		// the table with just a single client-header cell in it.
