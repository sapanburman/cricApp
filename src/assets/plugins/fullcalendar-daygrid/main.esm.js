...
var DayTile = /** @class */ (function (_super) {
    ...
    DayTile.prototype._renderFrame = function (date) {
        ...
        this.el.innerHTML =
            '<div class="fc-client-header ' + theme.getClass('popoverHeader') + '">' +
                '<span class="fc-title">' +
                htmlEscape(title) +
                '</span>' +
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.showSegPopover = function (row, col, moreLink, segs) {
        ...
        var options;
        if (this.rowCnt === 1) {
            topEl = view.el; // will cause the popover to cover any sort of client-header
        }
        else {
...
var DayGridView = /** @class */ (function (_super) {
    ...
    function DayGridView(context, viewSpec, dateProfileGenerator, parentEl) {
        ...
        /* Header Rendering
        ------------------------------------------------------------------------------------------------------------------*/
        // Generates the HTML that will go before the day-of week client-header cells
